...
public class GlideHelper {
    ...
    public static void loadProfileImageUrl(Activity activity, ImageView image, @Nullable String url) {
        // We don't want Glide to crop or resize our image
        final RequestOptions options = new RequestOptions()
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .circleCropTransform()
                .placeholder(R.color.colorGreyDark)
                .error(R.color.colorGreyDark);
    ...
    public static void loadImageUrl(ImageView image, @Nullable String url) {
        // We don't want Glide to crop or resize our image
        final RequestOptions options = new RequestOptions()
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .override(Target.SIZE_ORIGINAL)
